...
parser.add_argument('--lr', default=0.0095, type=float, help='learning rate')
...
parser.add_argument('--w_hc', default=0.55, type=float,
...
print('==> Loading data..')
# Data loading code
normalize = transforms.Normalize(mean=[0.480, 0.460, 0.410],std=[0.230, 0.220, 0.225])
